...
// Auto-generated page for: Regulatory RAG assistant over USFS/state permit texts, with 

export default function CfRegulatoryRagAssistantOverUsfsstate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-regulatory-rag-assistant-over-usfsstate-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Regulatory RAG assistant over USFS/state permit texts, with </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Regulatory RAG assistant over USFS/state permit texts, with automated environmental impact summaries.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Regulatory RAG assistant over USFS/state permit texts, with '}
        </button>
      </form>
