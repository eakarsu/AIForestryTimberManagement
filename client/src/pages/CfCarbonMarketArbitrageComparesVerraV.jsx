...
// Auto-generated page for: Carbon-market arbitrage

export default function CfCarbonMarketArbitrageComparesVerraV() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-carbon-market-arbitrage-compares-verra-v', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Carbon-market arbitrage</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Carbon-market arbitrage: compares Verra vs Gold Standard pricing, recommends optimal registry per parcel.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Carbon-market arbitrage'}
        </button>
      </form>
