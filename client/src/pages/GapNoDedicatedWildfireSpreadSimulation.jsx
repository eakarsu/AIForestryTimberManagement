...
// Auto-generated page for: No dedicated wildfire-spread-simulation endpoint (current wi

export default function GapNoDedicatedWildfireSpreadSimulation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dedicated-wildfire-spread-simulation-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No dedicated wildfire-spread-simulation endpoint (current wi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No dedicated wildfire-spread-simulation endpoint (current wildfire-risk is single-point scoring)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No dedicated wildfire-spread-simulation endpoint (current wi'}
        </button>
      </form>
