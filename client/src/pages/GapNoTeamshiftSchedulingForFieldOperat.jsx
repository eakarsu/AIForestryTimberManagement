...
// Auto-generated page for: No team/shift scheduling for field operations

export default function GapNoTeamshiftSchedulingForFieldOperat() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-teamshift-scheduling-for-field-operat', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No team/shift scheduling for field operations</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No team/shift scheduling for field operations</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No team/shift scheduling for field operations'}
        </button>
      </form>
