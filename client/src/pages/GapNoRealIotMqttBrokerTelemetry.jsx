...
// Auto-generated page for: No real IoT MQTT broker — telemetry endpoint is stubbed

export default function GapNoRealIotMqttBrokerTelemetry() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-real-iot-mqtt-broker-telemetry', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No real IoT MQTT broker — telemetry endpoint is stubbed</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No real IoT MQTT broker — telemetry endpoint is stubbed</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No real IoT MQTT broker — telemetry endpoint is stubbed'}
        </button>
      </form>
