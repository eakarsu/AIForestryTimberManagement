...
// Auto-generated page for: Agentic forest planning

export default function CfAgenticForestPlanningMultiAgentSyst() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-forest-planning-multi-agent-syst', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic forest planning</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic forest planning: multi-agent system coordinating harvest scheduling, equipment routing, and environmental compliance in real-time.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic forest planning'}
        </button>
      </form>
