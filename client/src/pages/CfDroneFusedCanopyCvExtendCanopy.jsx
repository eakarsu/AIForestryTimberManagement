...
// Auto-generated page for: Drone-fused canopy CV

export default function CfDroneFusedCanopyCvExtendCanopy() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-drone-fused-canopy-cv-extend-canopy', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Drone-fused canopy CV</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Drone-fused canopy CV: extend canopy-health endpoint with multi-temporal NDVI diffing for early disease/insect outbreak detection.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Drone-fused canopy CV'}
        </button>
      </form>
