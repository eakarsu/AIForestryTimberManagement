...
// Auto-generated page for: No SOP/RAG over forestry regulations (deferred per audit not

export default function GapNoSopragOverForestryRegulationsDefe() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-soprag-over-forestry-regulations-defe', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No SOP/RAG over forestry regulations (deferred per audit not</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No SOP/RAG over forestry regulations (deferred per audit notes)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No SOP/RAG over forestry regulations (deferred per audit not'}
        </button>
      </form>
