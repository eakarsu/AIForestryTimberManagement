...
// Auto-generated page for: Buyer-demand matching

export default function CfBuyerDemandMatchingPredictiveMarketp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-buyer-demand-matching-predictive-marketp', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Buyer-demand matching</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Buyer-demand matching: predictive marketplace pairing harvested timber to sawmills, paper mills, biomass plants with bid optimization.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Buyer-demand matching'}
        </button>
      </form>
