...
// Auto-generated page for: No labor scheduling AI for field crews

export default function GapNoLaborSchedulingAiForField() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-labor-scheduling-ai-for-field', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No labor scheduling AI for field crews</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No labor scheduling AI for field crews</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No labor scheduling AI for field crews'}
        </button>
      </form>
